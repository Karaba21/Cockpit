    ...
    return (
        <div className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
            ...
            <div className="space-y-8 text-foreground">
                ...
                {/* Intro Section */}
                <section>
                    {/* <h1 className="text-3xl md:text-4xl font-bold mb-4 text-primary">Política de privacidad</h1> */}
                    <p className="text-sm opacity-80 mb-6">Última actualización: 2 de diciembre de 2025</p>

                    <div className="space-y-4 leading-relaxed">
                        <p>
                            COCKPIT UY gestiona esta tienda y este sitio web, incluidos los datos, el contenido, las funciones, las herramientas, los productos y los servicios para ofrecerle a usted, el cliente, una experiencia de compra seleccionada (los “Servicios”). COCKPIT UY cuenta con tecnología de Shopify que nos permite ofrecerle los Servicios. Esta Política de privacidad describe cómo recopilamos, utilizamos y divulgamos su información personal cuando visita, utiliza o realiza una compra u otra transacción a través de los Servicios o cuando se comunica con nosotros por cualquier otro medio. En caso de conflicto entre nuestros Términos del Servicio y esta Política de privacidad, prevalecerá esta Política de privacidad en lo que respecta a la recopilación, el tratamiento y la divulgación de su información personal.
                        </p>
                        <p>
                ...
                {/* Información personal que recopilamos o tratamos */}
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Información personal que recopilamos o tratamos</h2>
                    <div className="space-y-4 leading-relaxed">
                        <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Fuentes de información personal</h2>
                    <p className="mb-4">Podemos recopilar información personal de las siguientes fuentes:</p>
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Cómo divulgamos la información personal</h2>
                    <p className="mb-4">En determinadas circunstancias, podemos divulgar su información personal a terceros por motivos legítimos, de conformidad con esta Política de privacidad. Tales circunstancias pueden incluir:</p>
                    <ul className="list-disc pl-5 space-y-2 leading-relaxed">
                        <li>Con Shopify, proveedores y otros terceros que prestan servicios en nuestro nombre (por ejemplo, gestión de TI, procesamiento de pagos, análisis de datos, atención al cliente, almacenamiento en la nube, gestión de pedidos y envíos).</li>
                        <li>
                ...
                {/* Datos de menores */}
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Datos de menores</h2>
                    <p className="leading-relaxed">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Seguridad y retención de su información</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Sus derechos y opciones</h2>
                    <p className="mb-4">
                    ...
                    <ul className="list-disc pl-5 space-y-2 mb-4 leading-relaxed">
                        <li><strong>Derecho de acceso:</strong> Puede tener derecho a solicitar el acceso a la información personal que conservamos sobre usted.</li>
                        <li><strong>Derecho de supresión:</strong> Puede tener derecho a solicitarnos la supresión de la información personal que conservamos sobre usted.</li>
                        <li><strong>Derecho de rectificación:</strong> Puede tener derecho a solicitar que rectifiquemos la información personal inexacta que conservamos sobre usted.</li>
                        <li><strong>Derecho a la portabilidad de los datos:</strong> Puede tener derecho a recibir una copia de la información personal que conservamos sobre usted y a solicitar que la transfiramos a un tercero, en determinadas circunstancias y con ciertas excepciones.</li>
                        <li><strong>Gestión de preferencias de comunicación:</strong> Podemos enviarle correos electrónicos promocionales, y usted puede optar por no recibirlos en cualquier momento utilizando la opción de cancelación de suscripción que aparece en nuestros correos electrónicos. Si opta por no recibirlos, es posible que sigamos enviándole correos electrónicos no promocionales, como aquellos relacionados con su cuenta o con los pedidos que haya realizado.</li>
                    </ul>
                    <p className="mb-4 leading-relaxed">
                        Podrá ejercer cualquiera de estos derechos en los lugares indicados en los Servicios o poniéndose en contacto con nosotros a través de los detalles de contacto que se proporcionan más abajo. Para obtener más información sobre cómo Shopify utiliza su información personal y sobre los derechos que pueda tener —incluidos los relacionados con los datos tratados por Shopify—, puede visitar https://privacy.shopify.com/en.
                    </p>
                    <p className="leading-relaxed">
                ...
                {/* Reclamaciones */}
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Reclamaciones</h2>
                    <p className="leading-relaxed">
                        Si tiene alguna reclamación sobre cómo tratamos su información personal, le rogamos que se ponga en contacto con nosotros a través de los detalles de contacto que se indican más abajo. Según el lugar en el que resida, es posible que tenga derecho a recurrir nuestra decisión poniéndose en contacto con nosotros a través de los detalles de contacto que se indican más abajo, o a presentar una reclamación ante la autoridad local de protección de datos.
                    </p>
                </section>

                {/* Transferencias internacionales */}
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Transferencias internacionales</h2>
                    <p className="mb-4">Tenga en cuenta que podemos transferir, almacenar y tratar su información personal fuera del país en el que reside.</p>
                    <p className="leading-relaxed">
                ...
                <section>
                    <h2 className="text-2xl font-bold mb-4 text-white">Cambios en esta Política de privacidad</h2>
                    <p className="leading-relaxed">
                ...
                <section>
                    ...
                    <p className="leading-relaxed">
                        Si tiene alguna pregunta sobre nuestras prácticas de privacidad o sobre esta Política de privacidad, o si desea ejercer cualquiera de los derechos que le corresponden, envíenos un correo electrónico a <a href="mailto:bruno.opertti@gmail.com" className="text-primary hover:underline">bruno.opertti@gmail.com</a> o póngase en contacto con nosotros en 6438 General Máximo Tajes, Montevideo, UY-MO, 11500, UY
                    </p>
                </section>
